...
const serviceLinks = [
  { label: 'Property Sales', path: '/services' },
  { label: 'Property Purchase', path: '/services' },
  { label: 'Investment Consulting', path: '/services' },
  { label: 'Property Management', path: '/services' },
  { label: 'Relocation Assistance', path: '/services' },
]
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 pt-20 lg:pt-28 pb-10">
        ...
        <div className="footer-fade grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <Link to={link.path} className="font-body text-[14px] text-black/60 hover:text-[#ff7a1a] transition-colors duration-300 cursor-hover">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        <div className="footer-fade flex flex-col md:flex-row items-center justify-between gap-4 text-[12px] text-black/50 font-body">
          <div className="flex gap-6">
            <Link to="#" className="hover:text-black transition-colors duration-300 cursor-hover">
              Privacy Policy
            </Link>
            <Link to="#" className="hover:text-black transition-colors duration-300 cursor-hover">
              Terms of Use
