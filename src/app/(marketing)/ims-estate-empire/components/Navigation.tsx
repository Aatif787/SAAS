...
const navLinks = [
  ...
  { label: 'About', path: '/ims-estate-empire/about' },
...
export default function Navigation() {
  ...
  const isHome = pathname === '/ims-estate-empire'
        ...
        <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
          <div className="flex items-center justify-between h-[72px]">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              {isAdmin && (
                <Link
                  href="/ims-estate-empire/admin"
                  className={`font-body text-[14px] tracking-[0.5px] transition-all duration-300 link-underline cursor-hover ${
                    pathname === '/ims-estate-empire/admin'
                      ? 'text-[#ff7a1a]'
                      : atTop && isHome && !scrolled
                        ? 'text-white/80 hover:text-white'
                        : 'text-black/70 hover:text-black'
