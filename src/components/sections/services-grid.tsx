...
const businesses = [
  ...
  {
    title: "IMS Steel & Infra",
    description: "Architectural steel engineering and high-tech infrastructure development shaping urban landscapes.",
  ...
  {
    title: "Estate Empire",
    description: "Premium high-rise developments and strategic real estate assets optimized for growth.",
    icon: <Building2 className="w-8 h-8" />,
    image: "/images/estate-empire-4k.png",
    color: "text-ims-red"
  },
  {
    title: "IMS Web Solution",
    description: "AI-driven digital transformation and enterprise-grade software engineering solutions.",
    icon: <Zap className="w-8 h-8" />,
    image: "/images/web-solution-4k.png",
    color: "text-ims-gold"
  },
  {
    title: "IMS Corporate Hub",
    description: "Synergizing diverse business verticals through centralized strategic leadership and innovation.",
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3 perspective-1000">
          {businesses.map((business, index) => (
            <motion.div
              ...
              className="group relative bg-transparent border border-ims-blue/5 p-1 transition-all duration-500 rounded-sm overflow-hidden will-change-transform"
            >
              ...
              <div className="px-10 pb-10">
                <motion.h3 
                  whileHover={{ x: 10 }}
                  className="text-3xl font-serif text-ims-blue leading-tight mb-6 group-hover:text-ims-red transition-colors"
                >
                  {business.title}
                </motion.h3>
